...
class DatabaseEquity {
  static DatabaseEquity _databaseEquity; // Singleton DatabaseEquity
  static Database _database; // Singleton Database

  String noteTable = 'equity_table';
  String colId = 'id';
  ...
  DatabaseEquity._createInstance(); // Named constructor to create instance of DatabaseEquity

  factory DatabaseEquity() {
    if (_databaseEquity == null) {
      _databaseEquity = DatabaseEquity
          ._createInstance(); // This is executed only once, singleton object
    }
    return _databaseEquity;
  }
