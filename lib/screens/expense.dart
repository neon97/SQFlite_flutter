...
import 'package:sql_trial/utils/expense_database.dart';

class ExpenseList extends StatefulWidget {
  final String appTitle;
  ExpenseList({this.appTitle});
  @override
...
class ExpenseListState extends State<ExpenseList> {
  DatabaseExpense databaseHelper = DatabaseExpense();
  List<Note> noteList;
  int count = 0;
...
class NoteDetailState extends State<NoteDetail> {
  ...
  DatabaseExpense helper = DatabaseExpense();
