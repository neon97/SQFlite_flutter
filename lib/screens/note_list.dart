...
class NoteListState extends State<NoteList> {
  ...
  ListView getNoteListView() {
		...
		return ListView.builder(
            ...
            children: <Widget>[
              Text(this.noteList[position].title, style: titleStyle,),
              ...
              Container(
                ...
                // child:Text(this.noteList[position].path)

                child: Image(
                image:MemoryImage(
                  base64Decode(this.noteList[position].path)
                ),
                fit: BoxFit.cover,
              ),
              )
          ...
          //  NetworkImage(this.noteList[position].path)
