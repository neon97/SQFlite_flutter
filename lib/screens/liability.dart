...
import 'package:sql_trial/utils/liabilities_database.dart';

class Liabilitylist extends StatefulWidget {
  final String appTitle;
  Liabilitylist({this.appTitle});
  @override
  State<StatefulWidget> createState() {
    return LiabilitylistState();
  }
}

class LiabilitylistState extends State<Liabilitylist> {
  DatabaseLiabilities databaseHelper = DatabaseLiabilities();
  List<Note> noteList;
  int count = 0;
...
class NoteDetailState extends State<NoteDetail> {
  ...
  DatabaseLiabilities helper = DatabaseLiabilities();
