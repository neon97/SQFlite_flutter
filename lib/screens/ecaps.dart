...
import 'package:sql_trial/utils/ecaps_database.dart';

class Ecapslist extends StatefulWidget {
  final String appTitle;
  Ecapslist({this.appTitle});
  @override
  State<StatefulWidget> createState() {
    return EcapslistState();
  }
}

class EcapslistState extends State<Ecapslist> {
  DatabaseEcaps databaseHelper = DatabaseEcaps();
  List<Note> noteList;
  int count = 0;
...
class NoteDetailState extends State<NoteDetail> {
  ...
  DatabaseEcaps helper = DatabaseEcaps();
