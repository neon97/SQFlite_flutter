...
class DatabaseLiabilities {
  static DatabaseLiabilities
      _databaseLiabilities; // Singleton DatabaseLiabilities
  static Database _database; // Singleton Database

  String noteTable = 'liabilities_table';
  String colId = 'id';
  String colTitle = 'title';
  String colAccountType = 'accountType';
  String colDescription = 'description';
  String colCurrency = 'currency';
  String colinsertDate = 'insertDate';
  String colupdateDate = 'updateDate';
  String colAmount = 'amount';
  String colTaxes = 'taxes';

  DatabaseLiabilities._createInstance(); // Named constructor to create instance of DatabaseLiabilities

  factory DatabaseLiabilities() {
    if (_databaseLiabilities == null) {
      _databaseLiabilities = DatabaseLiabilities
          ._createInstance(); // This is executed only once, singleton object
    }
    return _databaseLiabilities;
  }
