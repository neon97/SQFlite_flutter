...
class DatabaseAssets {
  static DatabaseAssets _databaseAssets; // Singleton DatabaseAssets
  static Database _database; // Singleton Database

  String noteTable = 'assets_table';
  String colId = 'id';
  ...
  DatabaseAssets._createInstance(); // Named constructor to create instance of DatabaseAssets

  factory DatabaseAssets() {
    if (_databaseAssets == null) {
      _databaseAssets = DatabaseAssets
          ._createInstance(); // This is executed only once, singleton object
    }
    return _databaseAssets;
  }
