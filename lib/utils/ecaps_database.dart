...
class DatabaseEcaps {
  static DatabaseEcaps _databaseEcaps; // Singleton DatabaseEcaps
  static Database _database; // Singleton Database

  String noteTable = 'ecaps_table';
  String colId = 'id';
  ...
  DatabaseEcaps._createInstance(); // Named constructor to create instance of DatabaseEcaps

  factory DatabaseEcaps() {
    if (_databaseEcaps == null) {
      _databaseEcaps = DatabaseEcaps
          ._createInstance(); // This is executed only once, singleton object
    }
    return _databaseEcaps;
  }
